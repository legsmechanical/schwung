...
## Summary
- 5547 nodes · 17858 edges · 40 communities detected
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 3907 edges (avg confidence: 0.8)
...
- `JS_ToFloat64()` --calls--> `js_tts_set_pitch()`  [INFERRED]
  libs/quickjs/quickjs-2025-04-26/quickjs.c → src/shadow/shadow_ui.c
- `JS_NewBool()` --calls--> `js_tts_get_enabled()`  [INFERRED]
  libs/quickjs/quickjs-2025-04-26/quickjs.h → src/shadow/shadow_ui.c
- `JS_NewBool()` --calls--> `js_display_mirror_get()`  [INFERRED]
  libs/quickjs/quickjs-2025-04-26/quickjs.h → src/shadow/shadow_ui.c
...
Cohesion: 0.01
Nodes (720): bswap16(), bswap32(), bswap64(), get_u64(), max_uint32(), min_uint32(), put_u16(), put_u32() (+712 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (612): js_point_ctor(), js_point_finalizer(), js_point_get_xy(), js_point_norm(), js_point_set_xy(), get_hi_surrogate(), get_lo_surrogate(), max_int() (+604 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (415): activateLedQueue(), adjustChainSetting(), adjustHierSelectedParam(), adjustKnobAndShow(), adjustLfoParam(), announceSavePreview(), applyComponentSelection(), applyComponentSelectionConfirmed() (+407 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (379): JackRequest(), JackResult(), Read(), Size(), Write(), analytics_diff_modules(), analytics_enabled(), analytics_init() (+371 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (365): lfo_tick(), lfo_advance_phase(), lfo_compute_shape(), lfo_rand_bipolar(), lfo_sync_rate_hz(), host_log(), capture_apply_group(), capture_clear() (+357 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (294): buildChainJson(), createEditorState(), createEmptyKnobs(), deleteChain(), disableComponentHostRouting(), disableSourceHostRouting(), drawComponentPicker(), drawComponentSelector() (+286 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (276): assert(), ColorPoint, main(), clz32(), clz64(), ctz32(), dbuf_error(), dbuf_free() (+268 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (116): CSRFProtection(), CSRFProtectionWithExemptions(), generateCSRFToken(), PathTraversalProtection(), SecurityHeaders(), ValidatePath(), App, AssetFile (+108 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (209): fib(), js_fib(), js_fib_init(), JS_INIT_MODULE(), js_init_module(), js_point_init(), js_display_register_bindings(), has_suffix() (+201 more)
...
Cohesion: 0.04
Nodes (137): bounded_strstr(), calc_knob_accel(), chain_get_clock_status(), chain_log(), chain_mod_alloc_target_entry(), chain_mod_apply_effective_value(), chain_mod_clampf(), chain_mod_clear_source() (+129 more)
...
Cohesion: 0.04
Nodes (59): clear_display(), draw_char(), draw_string(), load_synth(), main(), open_shm(), process_midi(), render_audio() (+51 more)
...
Cohesion: 0.05
Nodes (84): chown_to_ableton(), load_engine_choice(), save_engine_choice(), tts_cleanup(), tts_get_audio(), tts_get_enabled(), tts_get_pitch(), tts_get_speed() (+76 more)
...
Cohesion: 0.09
Nodes (37): barLengthModeLabel(), countNonEmpty(), describeEntry(), drainInjectQueue(), ensureEntryExists(), ensureTrailingEmpty(), findSongAbl(), firstCompleteEntry() (+29 more)
...
Cohesion: 0.11
Nodes (3): ShmConfig, boolU8(), OpenShmConfig()
...
Cohesion: 0.22
Nodes (11): compareVersions(), ensureTmpDir(), fetchCatalog(), fetchReleaseJson(), getInstallSubdir(), getModuleStatus(), installModule(), isValidModuleId() (+3 more)

### Community 26 - "Community 26"
Cohesion: 0.29
Nodes (14): assert(), assertThrows(), bigint_pow(), calc_pi(), ceil_log2(), compute_pi(), floor_log2(), int_sqrt() (+6 more)
...
- **Why does `assert()` connect `Community 6` to `Community 0`, `Community 1`, `Community 3`, `Community 7`, `Community 8`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `error()` connect `Community 7` to `Community 6`, `Community 8`, `Community 15`, `Community 16`, `Community 20`, `Community 23`, `Community 26`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `print()` connect `Community 5` to `Community 2`, `Community 3`, `Community 7`, `Community 11`, `Community 13`?**
...
- **Are the 145 inferred relationships involving `JS_NewInt32()` (e.g. with `JS_AtomIsNumericIndex1()` and `JS_NewObjectFromShape()`) actually correct?**
  _`JS_NewInt32()` has 145 INFERRED edges - model-reasoned connections that need verification._
